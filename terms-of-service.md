# SageBills Terms of Service

**Last Updated:** April 10, 2026 | **Effective:** April 1, 2026

---

> **In brief:** The agreement between you and SageBills. Clear, fair, and respectful of your rights as a European consumer. Your data stays on your device — we never see it.

---

## Key Points

- **Your Data, Your Device** — All data stays local. You own it completely. We never see it.
- **90-Day Free Trial** — Full Pro features free for 90 days. No credit card required.
- **Fair Pricing** — Monthly, yearly, or lifetime. Cancel anytime via Apple.
...
4. [Subscriptions and Pricing](#4-subscriptions-and-pricing)
5. [Free Grace Period](#5-free-grace-period)
6. [Billing and Cancellation](#6-billing-and-cancellation)
7. [Local-Only Data Model](#7-local-only-data-model)
8. [Data Ownership](#8-data-ownership)
9. [Intellectual Property](#9-intellectual-property)
10. [Prohibited Uses](#10-prohibited-uses)
11. [Warranties and Liability](#11-warranties-and-liability)
...
By downloading, installing, or using SageBills ("the App"), you agree to these Terms. If you do not agree, do not use the App.

These Terms constitute a legal agreement between you and SageBills, a sole proprietor based in Romania, EU. Your use is also governed by our [Privacy Policy](privacy-policy.md) and [GDPR Disclosure](gdpr-policy.md).
...
| Plan | Price | Billing |
|---|---|---|
| **Monthly** | EUR 2.99/month | Recurring monthly |
| **Yearly** | EUR 24.99/year | Recurring yearly |
| **Lifetime** | EUR 49.99 | One-time purchase |
...
New users receive a **90-day free grace period** with all premium features. The grace period:

- Begins on first app launch
- Cannot be reset by reinstalling
- Is tracked via a secure, non-personal Keychain timestamp

After expiration, continue using free features or subscribe to retain Pro access.
...
Refund requests must be submitted to Apple via [reportaproblem.apple.com](https://reportaproblem.apple.com).

## 7. Local-Only Data Model
...
- Circumvent the subscription system or grace period
...
THE APP IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED. WE DO NOT WARRANT THAT THE APP WILL BE UNINTERRUPTED, ERROR-FREE, OR THAT PREDICTIONS WILL BE ACCURATE. OUR TOTAL LIABILITY SHALL NOT EXCEED THE AMOUNT YOU PAID IN THE PRECEDING TWELVE MONTHS.
...
You may stop using SageBills at any time by uninstalling. Remember to cancel any active subscription separately. Upon termination, your data remains on your device.
...
The app is also subject to Apple's [Licensed Application EULA](https://www.apple.com/legal/internet-services/itunes/dev/stdeula/).
